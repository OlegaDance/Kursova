...
const AddVin = () => {
  ...
  const getValue = (label) =>
    result?.decode?.find((i) => i.label === label)?.value || null;
  ...
  const handleSubmit = async (e) => {
    ...
    const carData = {
      ...
      FuelConsumptionExtraUrban:
        parseFloat(getValue("Fuel Consumption Extra Urban")) || 1,
    ...
    try {
     ...
     formData.append("UploadedPhotos", photoFile);
    ...
    <div style={{ maxWidth: 600, margin: "auto" }}>
      ...
      {result && (
        <div style={{ marginBottom: 20 }}>
          <h3>VIN-дані отримані</h3>
          <p>
            <b>Марка:</b> {getValue("Make") || "немає даних"}
          </p>
          <p>
            <b>Модель:</b> {getValue("Model") || "немає даних"}
          </p>
          <p>
            <b>Рік випуску:</b> {getValue("Model Year") || "немає даних"}
          </p>
        </div>
      )}
